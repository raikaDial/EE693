...
// SPO2 Flag - Enabling this will create a flag in the Wire object, spo2_flag, which is set to true
//              in the I2C0 interrupt when the exchange is finished and there are 4 bytes available.
#define SPO2_CONNECTED
...
public:
    ...
    #if defined(SPO2_CONNECTED)
        uint8_t spo2_flag = 0; // signal main program when spo2 data is available
        uint8_t spo2_read = 0; // signals an spo2 read operation
