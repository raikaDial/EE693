...
Arduino Uno
*/
// Modified 11/30/2016 to remove I2C, and to change int to int16_t.
...
void ADXL345::powerOn() {
	// if(I2C) {
	// 	Wire.begin(I2C_MASTER, 0x00, I2C_PINS_18_19, I2C_PULLUP_EXT, 3200000); // If in I2C Mode Only
	// }
	//ADXL345 TURN ON
...
void ADXL345::readFromSPI(byte __reg_address, int16_t num, byte _buff[]) {
  ...
  //SPI.beginTransaction(SPISettings(SPIfreq, LSBFIRST,SPI_MODE3));
  digitalWrite(_CS, LOW);
...
/********************************************************************/
/*                                                                  */
// Print16_t Register Values to Serial Output =
